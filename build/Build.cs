...
class Build : NukeBuild
{
    ...
    Target TestPackages => _ => _
        ...
        .Executes(() =>
        {
            ...
            {
                TestsDirectory / "TemporalActivityGen.Nuget.IntegrationTests",
            };

            if (!string.IsNullOrEmpty(PackagesDirectory))
            {
                DeleteDirectory(PackagesDirectory / "temporalactivitygen");
                DeleteDirectory(PackagesDirectory / "temporalactivitygen.abstractions");
            }
